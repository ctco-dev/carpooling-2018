INSERT INTO USERS (ID, USERNAME, PASSWORD, ROLE, NAME, SURNAME, PHONENUMBER) VALUES (-1, 'admin', 'PBKDF2WithHmacSHA256:2048:McY8GmR3k1PjMwJQE97wYxbdCuJ2f7bBfwiNlOMT2Bc=:qnB+F68kaLGTITEiYfg8s+7+L1/5AKbiWgkKC4g2VKE=', 'ADMIN', 'Andris', 'Aplis', '1111111');
INSERT INTO USERS (ID, USERNAME, PASSWORD, ROLE, NAME, SURNAME, PHONENUMBER) VALUES (-2, 'user1', 'PBKDF2WithHmacSHA256:2048:McY8GmR3k1PjMwJQE97wYxbdCuJ2f7bBfwiNlOMT2Bc=:qnB+F68kaLGTITEiYfg8s+7+L1/5AKbiWgkKC4g2VKE=', 'USER', 'Brigita', 'Bagrova', '2222222');
INSERT INTO USERS (ID, USERNAME, PASSWORD, ROLE, NAME, SURNAME, PHONENUMBER) VALUES (-3, 'user2', 'PBKDF2WithHmacSHA256:2048:McY8GmR3k1PjMwJQE97wYxbdCuJ2f7bBfwiNlOMT2Bc=:qnB+F68kaLGTITEiYfg8s+7+L1/5AKbiWgkKC4g2VKE=', 'USER', 'Centa', 'Ceplite', '3333333');
...
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENT_ID, TRIPSTATUS) VALUES (-3, -2, 'CTCO', 'MEZCIEMS', 4, '19:00', FALSE ,NULL , 'ACTIVE');
