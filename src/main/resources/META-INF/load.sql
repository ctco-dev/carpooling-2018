...
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-1, -2, 'PURVCIEMS', 'CTCO', 3, '10:00', FALSE,'', 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-2, -1, 'CTCO', 'CENTRS', 3, '18:00', FALSE,'', 'ACTIVE');
...
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-5, -2, 'CTCO', 'VECMILGRAVIS', 3, '19:30', FALSE, '', 'ACTIVE');
