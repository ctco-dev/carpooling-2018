...
INSERT INTO EVENTS (ID, EVENTNAME, EVENTSTARTTIME) VALUES (-1, '', '');
...
INSERT INTO TRIPS (ID, DRIVER_ID, EVENT_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, TRIPSTATUS) VALUES (-1, -2, -1, 'PURVCIEMS', 'CTCO', 3, '10:00', FALSE, 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, EVENT_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, TRIPSTATUS) VALUES (-2, -1, -1, 'CTCO', 'CENTRS', 2, '18:00', FALSE, 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, EVENT_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, TRIPSTATUS) VALUES (-3, -2, -2, 'CTCO', 'MEZCIEMS', 4, '19:00', TRUE, 'FINISHED');
INSERT INTO TRIPS (ID, DRIVER_ID, EVENT_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, TRIPSTATUS) VALUES (-4, -3, -2, 'JUGLA', 'CTCO', 1, '09:00', TRUE , 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, EVENT_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, TRIPSTATUS) VALUES (-5, -2, -1  , 'CTCO', 'VECMILGRAVIS', 3, '19:30', FALSE, 'ACTIVE');
