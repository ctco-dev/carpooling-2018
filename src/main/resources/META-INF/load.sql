...
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-1, -2, 'PURVCIEMS', 'CTCO', 3, '10:00', FALSE,'Christmas-Party', 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-2, -1, 'CTCO', 'CENTRS', 2, '18:00', FALSE,'Garden-Party', 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-3, -2, 'CTCO', 'MEZCIEMS', 4, '19:00', TRUE,'Team-building', 'FINISHED');
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-4, -3, 'JUGLA', 'CTCO', 1, '09:00', TRUE ,'New Year', 'ACTIVE');
INSERT INTO TRIPS (ID, DRIVER_ID, DEPARTURE, DESTINATION, PLACES, DEPARTURETIME, ISEVENT, EVENTNAME, TRIPSTATUS) VALUES (-5, -2, 'CTCO', 'VECMILGRAVIS', 3, '19:30', FALSE, 'Birthday Party', 'ACTIVE');
...
INSERT INTO USER_TRIP (TRIP_ID, USER_ID) VALUES (-1, -2);
INSERT INTO USER_TRIP (TRIP_ID, USER_ID) VALUES (-1, -3);
INSERT INTO USER_TRIP (TRIP_ID, USER_ID) VALUES (-2, -2);
INSERT INTO USER_TRIP (TRIP_ID, USER_ID) VALUES (-2, -1);
